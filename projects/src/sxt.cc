...
void sext_terms(const double twoJ[])
{
  ...
  sxt_2(-1e0/64e0, 1, 0, 0, 2, 2, 1, 0, 0, c, s);
  h_c = c;
  h_s = s;
  sxt_2(-1e0/64e0, 3, 0, 0, 0, 0, 1, 0, 2, c, s);
  h_c += c;
  h_s += s;
  sxt_2(-4e0/64e0, 1, 0, 0, 2, 1, 0, 1, 1, c, s);
  h_c += c;
  h_s += s;
  h_c *= twoJ[X_]*twoJ[Y_];
  h_s *= twoJ[X_]*twoJ[Y_];
  ...
  sxt_2(-1e0/64e0, 3, 0, 0, 0, 0, 1, 2, 0, c, s);
  h_c = c;
  h_s = s;
  sxt_2(-1e0/64e0, 1, 0, 2, 0, 2, 1, 0, 0, c, s);
  h_c += c;
  h_s += s;
  sxt_2(-4e0/64e0, 1, 0, 1, 1, 1, 0, 2, 0, c, s);
  h_c += c;
  h_s += s;
  h_c *= twoJ[X_]*twoJ[Y_];
  h_s *= twoJ[X_]*twoJ[Y_];
  ...
  sxt_2(-1e0/32e0, 1, 0, 2, 0, 1, 2, 0, 0, c, s);
  h_c = c;
  h_s = s;
  sxt_2(-1e0/32e0, 2, 1, 0, 0, 0, 1, 2, 0, c, s);
  h_c += c;
  h_s += s;
  sxt_2(-2e0/32e0, 0, 1, 1, 1, 1, 0, 2, 0, c, s);
  h_c += c;
  h_s += s;
  sxt_2(-2e0/32e0, 1, 0, 1, 1, 0, 1, 2, 0, c, s);
  h_c += c;
  h_s += s;
  h_c *= twoJ[X_]*twoJ[Y_];
  h_s *= twoJ[X_]*twoJ[Y_];
  ...
  sxt_2(-1e0/64e0, 0, 1, 2, 0, 1, 0, 2, 0, h_c, h_s);
  h_c *= sqr(twoJ[Y_]);
  h_s *= sqr(twoJ[Y_]);
  printf("  h_00400: %23.16e %23.16e\n", h_c, h_s);

  sxt_2(-1e0/64e0, 0, 3, 0, 0, 3, 0, 0, 0, c, s);
  h_c = c;
  h_s = s;
  sxt_2(-3e0/64e0, 1, 2, 0, 0, 2, 1, 0, 0, c, s);
  h_c += c;
  h_s += s;
  h_c *= sqr(twoJ[X_]);
  h_s *= sqr(twoJ[X_]);
  ...
  sxt_2(-1e0/16e0, 1, 0, 1, 1, 1, 2, 0, 0, c, s);
  h_c = c;
  h_s = s;
  sxt_2(-1e0/16e0, 2, 1, 0, 0, 0, 1, 1, 1, c, s);
  h_c += c;
  h_s += s;
  sxt_2(-1e0/16e0, 0, 1, 0, 2, 1, 0, 2, 0, c, s);
  h_c += c;
  h_s += s;
  sxt_2(-1e0/16e0, 1, 0, 0, 2, 0, 1, 2, 0, c, s);
  h_c += c;
  h_s += s;
  h_c *= twoJ[X_]*twoJ[Y_];
  h_s *= twoJ[X_]*twoJ[Y_];
