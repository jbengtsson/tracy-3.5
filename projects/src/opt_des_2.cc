...
void set_straights(param_type &prms)
{
  // Mid-Straight.
  prms.add_prm("qf1",  2,   0.0, 20.0, 1.0);
  prms.add_prm("qd2",  2, -20.0,  0.0, 1.0);
  prms.add_prm("qp_q", 2,  -2.0,  2.0, 1.0);
...
void set_b2_constr(constr_type &constr)
{
...
void set_scl(constr_type &constr)
{
