...
template void radiate
(CellType &Cell, ss_vect<tps> &, const double, const double, const tps []);

template void radiate_ID
(CellType &Cell, ss_vect<double> &, const double, const double &);

template void radiate_ID
(CellType &Cell, ss_vect<tps> &, const double, const tps &);
...
template void thin_kick
(CellType &Cell, const int, const double [], const double, const double,
...
(const double, const double, const bool, ss_vect<double> &);

template void Cav_Focus
(const double, const double, const bool, ss_vect<tps> &);
...
template void Wiggler_pass_EF(CellType &Cell, ss_vect<tps> &x);

template void Wiggler_pass_EF2
(CellType &, int, double , double, double, double, double , double, double,
 ss_vect<double> &);

template void Wiggler_pass_EF2
(CellType &, int, double , double, double, double,
 double, double, double, ss_vect<tps> &);

template void Wiggler_pass_EF3(CellType &, ss_vect<double> &);

template void Wiggler_pass_EF3(CellType &, ss_vect<tps> &);
...
template void sol_pass(CellType &, ss_vect<double> &);

template void sol_pass(CellType &, ss_vect<tps> &);

template void Solenoid_Pass(CellType &, ss_vect<double> &);

template void Solenoid_Pass(CellType &, ss_vect<tps> &);

template void LinearInterpolation2
(double &, double &, double &, double &, double &, CellType &, bool &, int);

template void LinearInterpolation2
(tps &, tps &, tps &, tps &, tps &, CellType &, bool &, int);

template void SplineInterpolation2
(double &, double &, double &, double &, CellType &, bool &);

template void SplineInterpolation2
(tps &, tps &, tps &, tps &, CellType &, bool &);

template void spline
(const double [], const double [], int const, double const, const double,
 double []);

template void spline
(const double [], const tps [], int const, double const, const double, tps []);

template void splint
(const double[], const double [], const double [], const int, const double &,
 double &);

template void splint
(const double[], const double [], const double [], const int, const tps &,
 tps &);

template void splint
(const double[], const tps [], const tps [], const int, const tps &, tps &);

template void splin2
(const double [], const double [], double **, double **, const int, const int,
