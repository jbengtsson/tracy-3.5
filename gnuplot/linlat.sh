...
if (ps == 2) set output "linlat_1.pdf"
...
if (ps == 2) set output "linlat_2.pdf"
...
if (ps == 2) set output "linlat_3.pdf"
if (plt_nu) \
...
if (ps == 2) set output "linlat_4.pdf"
if (plt_nu) \
  set title "{/Symbol a}"; \
...
if (ps == 2) set output "linlat_5.pdf"
...
if (ps == 2) set output "linlat_6.pdf"
