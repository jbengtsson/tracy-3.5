...
i22_5  = floor(2.0*nu_x_min+2.0*nu_y_max) + 2.0
...
i2m2_4 = floor(2.0*nu_x_min-2.0*nu_y_min) + 2.0
...
if (scale) set xrange [nu_x_min:nu_x_max]
set yrange [nu_y_min:nu_y_max] 
splot "fmap.out" using \
      ...
      u,     (i22_5-2.0*u)/2.0,  1.0 notitle with lines ls 3, \
      ...
      u,     (2.0*u-i2m2_4)/2.0, 1.0 notitle with lines ls 3, \
                                                              \
...
set xlabel "x [mm]"
set ylabel "y [mm]"
if (scale) set xrange [-x_max:x_max]
