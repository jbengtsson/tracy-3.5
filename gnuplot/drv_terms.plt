...
plot file_name using 2:5 title "h_{30000}" with steps ls 1, \
     ...
     file_name using 2:8 title "h_{10020}" with steps ls 4, \
     file_name using 2:9 title "h_{10110}" with steps ls 5;
if (!ps) pause mouse "click on graph to cont.\n";
...
plot file_name using 2:10 title "h_{40000}" with steps ls 1, \
     ...
     file_name using 2:13 title "h_{11200}" with steps ls 4, \
     file_name using 2:14 title "h_{00400}" with steps ls 5, \
     file_name using 2:15 title "h_{20110}" with steps ls 6, \
     file_name using 2:16 title "h_{00310}" with steps ls 7, \
...
plot file_name using 2:18 title "h_{50000}" with steps ls 1, \
     ...
     file_name using 2:21 title "h_{30200}" with steps ls 4, \
     file_name using 2:22 title "h_{21200}" with steps ls 5, \
     file_name using 2:23 title "h_{10400}" with steps ls 6, \
     file_name using 2:24 title "h_{30110}" with steps ls 7, \
     file_name using 2:25 title "h_{21110}" with steps ls 8, \
     file_name using 2:26 title "h_{10310}" with steps ls 1, \
     file_name using 2:27 title "h_{30020}" with steps ls 2, \
     file_name using 2:28 title "h_{21020}" with steps ls 3, \
     file_name using 2:29 title "h_{10220}" with steps ls 4, \
     file_name using 2:30 title "h_{10130}" with steps ls 5, \
     file_name using 2:31 title "h_{10040}" with steps ls 6, \
     file_name using 2:32 title "h_{01040}" with steps ls 7;
if (!ps) pause mouse "click on graph to cont.\n";
